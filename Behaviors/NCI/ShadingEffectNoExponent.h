...
#ifndef SHADINGEFFECTNOEXPONENT_H_
#define SHADINGEFFECTNOEXPONENT_H_
 ...
 * </ul>
 */
class clShadingEffectNoExponent: virtual public clShadingEffectBase {
public:
  /**
   * Constructor.
   */
  clShadingEffectNoExponent();

  /**
   * Destructor.
   */
  virtual ~clShadingEffectNoExponent();
...
#endif /* SHADINGEFFECTNOEXPONENT_H_ */
