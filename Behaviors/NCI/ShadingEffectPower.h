#ifndef SHADINGEFFECTPOWER_H_
#define SHADINGEFFECTPOWER_H_
 ...
 */
class clShadingEffectPower: virtual public clShadingEffectBase {
public:
  /**
   * Constructor.
   */
  clShadingEffectPower();
