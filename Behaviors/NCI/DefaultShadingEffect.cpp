#include "DefaultShadingEffect.h"
...
// Constructor
//////////////////////////////////////////////////////////////////////////////
clDefaultShadingEffect::clDefaultShadingEffect() {
...
//////////////////////////////////////////////////////////////////////////////
float clDefaultShadingEffect::CalculateShadingEffect(clTree *p_oTree) {
...
// DoSetup
//////////////////////////////////////////////////////////////////////////////
void clDefaultShadingEffect::DoSetup(clTreePopulation *p_oPop, clBehaviorBase *p_oNCI, xercesc::DOMElement *p_oElement) {
  ...
  for (i = 0; i < p_oNCI->GetNumSpeciesTypeCombos(); i++) {
    ...
    if ( -1 == mp_iLightCodes[c.iSpecies][c.iType]) {
      modelErr stcErr;
      stcErr.sFunction = "clDefaultShadingEffect::DoSetup";
