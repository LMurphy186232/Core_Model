...
// BBDInfestation
//---------------------------------------------------------------------------
#if !defined(BBDInfestation_H)
  #define BBDInfestation_H

#include "BehaviorBase.h"


/**
* Birch Bark Disease Infestation version 1.0.
*
* This behavior simulates the spread of birch bark disease throughout a tree
* population.
*
...
* called "BBDResistanceStatus" and equals a value in the enum bbdResistanceStatus
* in DataTypes.h.
*
...
*
* This behavior's call string and name string are both "BBDInfestation".
*
...
*/
class clBBDInfestation : virtual public clBehaviorBase {
  ...
  */
  clBBDInfestation(clSimManager *p_oSimManager);
  ...
  */
  ...
  /**
  * Registers the "YearsInfested" and "BBDResistanceStatus" int data members.
  */
  ...
  /**Return codes for the "BBDResistanceStatus" int tree data member. Array
   * index one is sized m_iTotalNumSpecies; array index two is sized number of
   * total types.*/
  short int **mp_iBBDResistanceStatusCodes;
